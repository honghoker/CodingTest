    ...
    while front < queue.count {
        ...
        for i in 0...3 {
            ...
            if board[nRX][nRY] == "O" && board[nBX][nBY] == "." {
                return (c + 1, d + direction[i])
            } else if board[nRX][nRY] == "." && board[nBX][nBY] == "." {
                queue.append((r: (nRX, nRY), b: (nBX, nBY), c: c + 1, d: d + direction[i]))
